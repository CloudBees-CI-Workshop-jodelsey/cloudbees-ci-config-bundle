...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/CloudBees-CI-Workshop-jodelsey/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>CloudBees-CI-Workshop-jodelsey</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>CloudBees-CI-Workshop-jodelsey</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/CloudBees-CI-Workshop-jodelsey/pipeline-template-catalog.git</repositoryUrl>
              <traits>
